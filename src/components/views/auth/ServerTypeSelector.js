...
const MODULAR_URL =
    "https://modular.im/?utm_source=riot-web&utm_medium=web&utm_campaign=riot-web-authentication";
...
export const TYPES = {
    FREE: {
        ...
        label: () => _t("Free"),
        logo: () => (
            <img src={require("../../../../res/img/matrix-org-bw-logo.svg")} />
        ),
        description: () =>
    ...
    PREMIUM: {
        ...
        label: () => _t("Premium"),
        logo: () => (
            <img src={require("../../../../res/img/modular-bw-logo.svg")} />
        ),
        description: () =>
            _t(
                "Premium hosting for organisations <a>Learn more</a>",
                {},
                {
                    a: (sub) => (
                        <a
    ...
    ADVANCED: {
        ...
        description: () =>
            _t("Find other public servers or use a custom server"),
    },
};
    ...
    render() {
        ...
        for (const type of Object.values(TYPES)) {
            ...
            const classes = classnames(
                ...
                {
                    mx_ServerTypeSelector_type_selected:
            ...
            serverTypes.push(
                <div className={classes} key={id}>
                    <div className="mx_ServerTypeSelector_label">{label()}</div>
        ...
        return (
            <div className="mx_ServerTypeSelector">{/* {serverTypes} */}</div>
        );
    }
}
